...
var $author$project$Main$Inputting = 0;
...
var $author$project$Main$Operating = 1;
var $author$project$Main$operatedModel = F2(
	function (model, func) {
		var m = model;
...
var $author$project$Main$normalizeDigits = function (s) {
	return A2(
...
var $author$project$Main$updateAddDigit = F2(
	function (c, s) {
		return $author$project$Main$normalizeDigits(
			_Utils_ap(s, c));
	});
			...
			case 0:
				...
				if (_v2 === 2) {
					...
					return _Utils_update(
						m,
						{
							a: A2($author$project$Main$updateAddDigit, v, m.a)
						});
				}
			case 1:
				var func = msg.a;
				...
				switch (_v4) {
					case 0:
						return {a: '0', f: m.a, k: func, l: 1};
					case 1:
						return A2(
							$author$project$Main$operatedModel,
							m.k(m),
							func);
					default:
						return {a: '0', f: m.a, k: func, l: 1};
...
var $author$project$Main$Executer = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Main$updateAddOperator = function (model) {
	var m = model;
	var _v1 = A2(
		$elm$core$List$map,
	...
	if ((((_v1.b && (!_v1.a.$)) && _v1.b.b) && (!_v1.b.a.$)) && (!_v1.b.b.b)) {
		...
		return _Utils_update(
			...
			{
				a: '0',
				f: $author$project$Main$normalizeDigits(
					$elm$core$String$fromFloat(a + b)),
				k: function (lam) {
					return lam;
				}
			});
...
var $author$project$Main$updateClsOperator = function (model) {
	var m = model;
	return {
		a: '0',
		f: '0',
...
var $author$project$Main$Outputting = 2;
var $author$project$Main$updateEqOperator = function (model) {
	var m = model;
	var _v1 = m.l;
	if (!_v1) {
		return _Utils_update(
...
var $author$project$Main$updateMultOperator = function (model) {
	var m = model;
	var _v1 = A2(
		$elm$core$List$map,
		$elm$core$String$toFloat,
...
var $author$project$Main$updateQuotOperator = function (model) {
	var m = model;
	var _v1 = A2(
		$elm$core$List$map,
		$elm$core$String$toFloat,
...
var $author$project$Main$updateSubOperator = function (model) {
	var m = model;
	var _v1 = A2(
		$elm$core$List$map,
		$elm$core$String$toFloat,
...
var $author$project$Main$viewBtnGen = F2(
	function (msg, fieldTxt) {
		return A2(
